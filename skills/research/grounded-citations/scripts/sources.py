...
Ledger path resolution (first wins):
  --ledger PATH
  $CITATION_LEDGER
  $HOME/.local/share/agent-skills/cache/citations/ledger.json
"""
...
from _skills_home import get_skills_home  # noqa: E402
...
def resolve_ledger_path(explicit: str | None = None) -> Path:
    ...
    return get_skills_home() / "cache" / "citations" / "ledger.json"
